...
import {MdTune, MdCloud, MdComputer, MdLightbulb} from 'react-icons/md';
    ...
    return (
        <Panel variant="card" title="Form Element Showcase" icon={MdTune} titleId="form-elements-title">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <Panel variant="default" title="Select Dropdowns" className="md:col-span-2" titleId="selects-subtitle">
